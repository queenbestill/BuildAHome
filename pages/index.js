    ...
    <div className={`relative ${data.showCursor && "cursor-none"}`}>
      ...
      <div className="container mx-auto mb-10">
        ...
        <div className="mt-10 laptop:mt-30 p-2 laptop:p-0" ref={workRef}>
          ...
          <Carousel images={galleries.lisboa} title="Lisboa" />
          <Carousel images={galleries.cascais} title="Cascais" />
          <Carousel images={galleries.braga} title="Braga" />
        </div>

        <div className="mt-20 laptop:mt-34 p-2 laptop:p-0">
