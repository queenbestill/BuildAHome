...
const Edit = () => {
  ...
  const handleEditExperiences = (index, editExperience) => {
    let copyExperiences = data.impact.experiences;
    copyExperiences[index] = { ...editExperience };
    setData({
      ...data,
      impact: { ...data.impact, experiences: copyExperiences },
    });
  };
      ...
      <div className="mt-10">
        ...
        {currentTabs === "HEADER" && (
          <div className="mt-10">
            ...
            <div className="mt-5 flex items-center">
              <label className="w-1/5 text-lg opacity-50">Show Impact</label>
              <div className="w-4/5 ml-10 flex items-center">
                <Button
                  onClick={() => setData({ ...data, showImpact: true })}
                  type={data.showImpact && "primary"}
                >
                  Yes
                </Button>
                <Button
                  onClick={() => setData({ ...data, showImpact: false })}
                  classes={
                    !data.showImpact && "bg-red-500 text-white hover:bg-red-600"
                  }
                >
                  No
                </Button>
        ...
        {currentTabs === "IMPACT" && (
          <div className="mt-10">
            ...
            <div className="mt-5 flex items-center">
              ...
              <input
                value={data.impact.tagline}
                onChange={(e) =>
                  setData({
                    ...data,
                    impact: { ...data.impact, tagline: e.target.value },
                  })
                }
                className="w-4/5 ml-10 p-2 rounded-md shadow-lg border-2"
                type="text"
            ...
            <div className="mt-10">
              ...
              <div className="flex items-center mt-5">
                <label className="w-1/5 text-lg opacity-50">Name</label>
                <input
                  value={data.impact.education.universityName}
                  onChange={(e) =>
                    setData({
                      ...data,
                      impact: {
              ...
              <div className="flex items-center mt-5">
                <label className="w-1/5 text-lg opacity-50">Dates</label>
                <input
                  value={data.impact.education.universityDate}
                  onChange={(e) =>
                    setData({
                      ...data,
                      impact: {
              ...
              <div className="flex items-center mt-5">
                ...
                <input
                  value={data.impact.education.universityPara}
                  onChange={(e) =>
                    setData({
                      ...data,
                      impact: {
            ...
            <div className="mt-10">
              <div className="flex">
                ...
                <div className="w-4/5 ml-10 flex flex-col">
                  {data.impact.languages.map((language, index) => (
                        ...
                        onChange={(e) => {
                          setData({
                            ...
                            impact: {
                              ...data.impact,
                              languages: [
                                ...data.impact.languages.slice(0, index),
                                e.target.value,
                                ...data.impact.languages.slice(index + 1),
                              ],
                            },
                          });
                        }}
                      ...
                      <Button
                        onClick={() =>
                          setData({
                            ...
                            impact: {
                              ...data.impact,
                              languages: data.impact.languages.filter(
                                (value, i) => index !== i
                              ),
                            },
                          })
              ...
              <div className="flex">
                ...
                <div className="w-4/5 ml-10 flex flex-col">
                  {data.impact.frameworks.map((framework, index) => (
                    <div key={index} className="flex">
                      <input
                        value={framework}
                        onChange={(e) => {
                          setData({
                            ...
                            impact: {
                              ...data.impact,
                              frameworks: [
                                ...data.impact.frameworks.slice(0, index),
                                e.target.value,
                                ...data.impact.frameworks.slice(index + 1),
                              ],
                            },
                          });
                        }}
                      ...
                      <Button
                        onClick={() =>
                          setData({
                            ...
                            impact: {
                              ...data.impact,
                              frameworks: data.impact.frameworks.filter(
                                (value, i) => index !== i
                              ),
                            },
                          })
                  ...
                  <Button
                    onClick={() =>
                      setData({
                        ...
                        impact: {
                          ...data.impact,
                          frameworks: [...data.impact.frameworks, "Added"],
                        },
                      })
                    }
                    type="primary"
              ...
              <div className="flex">
                ...
                <div className="w-4/5 ml-10 flex flex-col">
                  {data.impact.others.map((other, index) => (
                    <div key={index} className="flex">
                      <input
                        value={other}
                        onChange={(e) => {
                          setData({
                            ...
                            impact: {
                              ...data.impact,
                              others: [
                                ...data.impact.others.slice(0, index),
                                e.target.value,
                                ...data.impact.others.slice(index + 1),
                              ],
                            },
                          });
                        }}
                      ...
                      <Button
                        onClick={() =>
                          setData({
                            ...
                            impact: {
                              ...data.impact,
                              others: data.impact.others.filter(
                                (value, i) => index !== i
                              ),
                            },
                          })
                  ...
                  <Button
                    onClick={() =>
                      setData({
                        ...
                        impact: {
                          ...data.impact,
                          others: [...data.impact.others, "Added"],
                        },
                      })
                    }
                    type="primary"
